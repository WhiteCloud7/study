<template>
  <div class="contact-info">
    <button class="btn-github">
      ...
      <span><a href="https://github.com/WhiteCloud7/study" class="href">点我前往github</a></span>
    </button>
    <div class="contact-qqContainer"><img  class="contact-qq" src="QQ.png"><span style="text-decoration: underline;font-size: 20px">&nbsp;2334646904</span></div>
    <div class="contact-weChatContainer"><img  class="contact-weChat" src="weChat.png"><span style="text-decoration: underline;font-size: 20px">&nbsp;cCloud7777777</span></div>
  </div>
</template>
